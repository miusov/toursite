...
<div class="row">
	<div class="left col-md-6">
		...
		$res=mysql_query($sel);
		echo '<form action="index.php?page=4" method="post" class="form">';
	...
	<div class="right col-md-6">
		...
		echo '<form action="index.php?page=4" method="post" class="form">';
		$sel='SELECT ci.id,ci.city,co.country FROM cities ci, countries co WHERE ci.countryid=co.id';
		$res=mysql_query($sel);
		echo '<table width="50%" class="table table-striped">';
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-8">
			...
			echo '<input type="text" name="stars" placeholder="Stars" class="inputwidth">';
